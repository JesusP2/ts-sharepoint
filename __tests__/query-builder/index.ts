// import { q eryBuilder, alias, json } from '@/query-builder';
import {
  queryBuilder,
  type Expand,
  type OrderBy,
...
describe('filter', () => {
  describe('comparison operators', () => {
    it('should handle basic filter without operator', () => {
      ...
      const actual = queryBuilder({ filter });
    ...
    it('should allow "has" operator', () => {
      const filter = {
        SomeProp: { has: { type: 'raw', value: "Sales.Pattern'Yellow'" } },
      };
      const expected = "?$filter=SomeProp has Sales.Pattern'Yellow'";
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
  ...
  describe('logical operators', () => {
    ...
    it('should handle implied logical operator on a single property using alises', () => {
      ...
      let actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    ...
    it('should handle nested logical operators', () => {
      ...
      const expected =
        '?$filter=((Prop1 eq 1) or ((Prop2 eq 2 and Prop3 eq 3)))';
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
  ...
  describe('collection operators', () => {
    ...
    it('should handle collection operator over simple string collection with any', () => {
      ...
      const expected =
        "?$filter=MacAddress/any(macaddress: macaddress eq '3C:4A:92:F1:98:E2')";
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
    ...
    it('should handle collection operator over simple string collection with all', () => {
      ...
      const expected =
        "?$filter=MacAddress/all(macaddress: macaddress ne '3C:4A:92:F1:98:E2')";
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
    ...
    it('should handle collection operator with "or" operator on the item of a simple collection', () => {
      const filter = {
        tags: {
          any: {
            or: [{ [ITEM_ROOT]: 'tag1' }, { [ITEM_ROOT]: 'tag2' }],
          },
        },
      };
    ...
    it('should handle collection operator with a function on the item of a simple collection', () => {
      ...
      const expected = "?$filter=tags/any(tags:tolower(tags) eq 'tag1')";
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
  });
  ...
  describe('data types', () => {
    ...
    it('should handle Duration values', () => {
      ...
      const expected = "?$filter=someProp eq duration'PT1H'";
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
    ...
    it('should handle Duration values with an in operator', () => {
      ...
      const expected = "?$filter=someProp in (duration'PT1H',duration'PT2H')";
      const actual = queryBuilder({ filter });
      assert.equal(actual, expected);
    });
...
describe('search', () => {
  it('should handle basic search string', () => {
    ...
    const actual = queryBuilder({ search });
    assert.equal(actual, expected);
  });
});
...
describe('transform', () => {
  it('simple aggregation as object', () => {
    ...
    const actual = queryBuilder({ transform });
    assert.equal(actual, expected);
  });
...
describe('select', () => {
  it('should support passing an array of strings', () => {
    ...
    const actual = queryBuilder({ select });
    assert.equal(actual, expected);
  });
...
describe('orderBy', () => {
  it('should support passing an array of strings', () => {
    ...
    const actual = queryBuilder({ orderBy });
    assert.equal(actual, expected);
  });
  ...
  it('should support passing an array of fields', () => {
    type Bar = { foo: unknown; bar: unknown };
  ...
  it('should support ordering a nested property within an expand', () => {
    ...
    const actual = queryBuilder(query);
    assert.equal(actual, expected);
  });
...
describe('key', () => {
  ...
  it('should support key with filter', () => {
    ...
    const actual = queryBuilder({ key, filter });
    assert.equal(actual, expected);
  });

  it('should support key with expand', () => {
    type Bar = { Foo: unknown };
    const key = 1;
    const expand = ['Foo'] as Expand<Bar>;
    const expected = '(1)?$expand=Foo';
    const actual = queryBuilder<Bar>({ key, expand });
    assert.equal(actual, expected);
  });
});
...
describe('count', () => {
  it('should support include counts', () => {
    ...
    const actual = queryBuilder({ count });
    assert.equal(actual, expected);
  });
  ...
  it('should allow groupby when querying for only count', () => {
    ...
    const actual = queryBuilder({ count, transform });
    assert.equal(actual, expected);
  });
});
...
describe('pagination', () => {
  ...
  it('should support skipping', () => {
    ...
    const actual = queryBuilder({ skip });
    assert.equal(actual, expected);
  });
  ...
  it('should support skipping by token', () => {
    ...
    const actual = queryBuilder({ skiptoken });
    assert.equal(actual, expected);
  });
  ...
  it('should support paginating (skip and limiting)', () => {
    ...
    const actual = queryBuilder({ top, skip });
    assert.equal(actual, expected);
  });
...
describe('expand', () => {
  it('should support basic expansion', () => {
    ...
    const actual = queryBuilder({ expand });
    assert.equal(actual, expected);
  });
  ...
  it('should support multiple expands as an array', () => {
    ...
    const actual = queryBuilder<Bar>({ expand });
    assert.equal(actual, expected);
  });
  ...
  it('should allow multiple nested expands with objects', () => {
    type Bar = { Friends: { Photos: unknown }; One: { Two: unknown } };
  ...
  it('should allow expand with levels', () => {
    type Bar = { Friends: { Photos: unknown }; One: { Two: unknown } };
    const expand: Expand<Bar> = {
      Friends: { expand: { Photos: { levels: 10 } } },
    };
  ...
  it('should allow expand with max levels', () => {
    type Bar = { Friends: { Photos: unknown }; One: { Two: unknown } };
    const expand: Expand<Bar> = {
      Friends: { expand: { Photos: { levels: 'max' } } },
    };
...
describe('action', () => {
  it('should support an action on a collection', () => {
    const action = 'Test';
    const expected = '/Test';
    const actual = queryBuilder({ action });
    assert.equal(actual, expected);
  });
  ...
  it('should support an action on an entity', () => {
    ...
    const actual = queryBuilder({ key, action });
    assert.equal(actual, expected);
  });
});
...
describe('function', () => {
  it('should support a function on a collection', () => {
    const func = 'Test';
    const expected = '/Test';
    const actual = queryBuilder({ func });
    assert.equal(actual, expected);
  });
  ...
  it('should support a function on an entity', () => {
    ...
    const func = 'Test';
    const expected = '(1)/Test';
    const actual = queryBuilder({ key, func });
    assert.equal(actual, expected);
  });
...
describe('format', () => {
  it('should support format', () => {
    ...
    const actual = queryBuilder({ format });
    assert.equal(actual, expected);
  });
});
